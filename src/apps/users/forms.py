...
class UserRegisterForm(UserCreationForm):
    ...
    last_name = forms.CharField(
        ...
        label=_("Фамилия"),
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": _("Введите вашу фамилию")}
        ),
    )
    phone = forms.CharField(
        ...
        label=_("Телефон"),
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": _("+7 (XXX) XXX-XX-XX")}
        ),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["username"].widget.attrs.update(
            {"class": "form-control", "placeholder": _("Введите имя пользователя")}
        )
        self.fields["password1"].widget.attrs.update(
            {"class": "form-control", "placeholder": _("Введите пароль")}
        )
        self.fields["password2"].widget.attrs.update(
            {"class": "form-control", "placeholder": _("Повторите пароль")}
        )
